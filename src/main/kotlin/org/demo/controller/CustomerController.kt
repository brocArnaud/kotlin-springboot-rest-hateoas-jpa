...
//	fun search(pageable: Pageable, criteria: CustomerResource): HttpEntity<PagedResources<CustomerResource>> {
		var result: Page<Customer> = customerService.search(pageable)
