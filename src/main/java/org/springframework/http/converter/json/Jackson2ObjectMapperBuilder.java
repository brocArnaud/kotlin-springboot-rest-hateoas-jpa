 ...
 * <li>{@link DeserializationFeature#FAIL_ON_UNKNOWN_PROPERTIES} is
 * disabled</li>
 * </ul>
 *
 * <p>
 * Note that Jackson's JSR-310 and Joda-Time support modules will be registered
 * automatically when available (and when Java 8 and Joda-Time themselves are
 * available, respectively).
 *
 * <p>
 * Tested against Jackson 2.2, 2.3 and 2.4; compatible with Jackson 2.0 and
 * higher.
 *
...
public class Jackson2ObjectMapperBuilder {
	 ...
	 * default constructor. This is only applicable to {@link #build()} calls, not
	 * to {@link #configure} calls.
	 */
	...
	/**
	 * Override the default {@link Locale} to use for formatting. Default value used
	 * is {@link Locale#getDefault()}.
	 * 
	 * @since 4.1.5
	 */
	...
	/**
	 * Override the default {@link TimeZone} to use for formatting. Default value
	 * used is UTC (NOT local timezone).
	 * 
	 * @since 4.1.5
	 */
	...
	/**
	 * Set an {@link AnnotationIntrospector} for both serialization and
	 * deserialization.
	 */
	...
	public Jackson2ObjectMapperBuilder serializationInclusion(JsonInclude.Include serializationInclusion) {
		System.out.println("=====================================> serializationInclusion : " + serializationInclusion);
	 ...
	 * @since 4.1.2
	 * @see com.fasterxml.jackson.databind.ObjectMapper#addMixInAnnotations(Class,
	 *      Class)
	 */
	 ...
	 * 
	 * @param mixIns
	 *            Map of entries with target classes (or interface) whose
	 *            annotations to effectively override as key and mix-in classes (or
	 *            interface) whose annotations are to be "added" to target's
	...
	/**
	 * Shortcut for {@link DeserializationFeature#FAIL_ON_UNKNOWN_PROPERTIES}
	 * option.
	 */
	 ...
	 * JSR-310 and Joda-Time, or Jackson's finding of modules (see
	 ...
	 * <p>
	 * If this mode is not set, Spring's Jackson2ObjectMapperBuilder itself will try
	 * to find the JSR-310 and Joda-Time support modules on the classpath - provided
	 * that Java 8 and Joda-Time themselves are available, respectively.
	 * 
	 ...
	 * {@link JsonDeserializer}, {@link KeyDeserializer},
	...
	/**
	 * Set the Spring {@link ApplicationContext} in order to autowire Jackson
	 * handlers ({@link JsonSerializer}, {@link JsonDeserializer},
	 * {@link KeyDeserializer}, {@code TypeResolverBuilder} and
	 * {@code TypeIdResolver}).
	 * 
	 * @since 4.1.3
	...
	// Any change to this method should be also applied to spring-jms and
	// spring-messaging
	...
	/**
	 * Obtain a {@link Jackson2ObjectMapperBuilder} instance in order to build a
	 * regular JSON {@link ObjectMapper} instance.
	 */
